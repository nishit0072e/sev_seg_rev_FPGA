...
HD_PWD='D:/test/seven_seg_rev/seven_seg_rev.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_segment_LED_Display_Controller.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Seven_segment_LED_Display_Controller.tcl -notrace
