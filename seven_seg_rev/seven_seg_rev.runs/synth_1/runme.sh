...
HD_PWD='D:/test/seven_seg_rev/seven_seg_rev.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_segment_LED_Display_Controller.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Seven_segment_LED_Display_Controller.tcl
